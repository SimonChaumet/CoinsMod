package fr.scarex.coinsmod.inventory;
 ...
 * 
 */
public class InventoryPurse implements IInventory
{
	public ItemStack[] content;
	public int size;

	public InventoryPurse(ItemStack container, int size) {
		this.size = size;
	...
	public String getInventoryName() {
		return CoinsMod.MODID + ".container.purse";
	}
